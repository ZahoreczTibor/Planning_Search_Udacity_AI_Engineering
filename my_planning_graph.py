...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        # Build the action level from the accessible action nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Make sure if node_a1 effects are not negated by node_a2's rem effects
        for effect in node_a1.action.effect_add:
            if effect in node_a2.action.effect_rem:
                return True

        # Avoid node_a2 effects are not negated by node_a1's rem effects
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Avoid nodes (a1, a2) effects do not conflict with nodes preconditions
        for effect in node_a1.action.effect_add:
        ...
        # Avoid nodes (a1, a2) rem effects do not conflict with nodes preconditions
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # node_s1's preconditions aren't mutually exclusive with node_s2's preconditions
